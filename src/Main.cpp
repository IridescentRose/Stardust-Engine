...
int main() {
	...
	Graphics::Texture* charTex = Graphics::TextureUtil::LoadTex("./link.png");
	...
	Graphics::Render2D::Tilemap* tmap = new Graphics::Render2D::Tilemap(new Graphics::TextureAtlas(32), Graphics::TextureUtil::LoadTex("./terrain_atlas.png"));
